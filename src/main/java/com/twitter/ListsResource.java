...
public class ListsResource {
    ...
    @See(href="get/lists/members/show", value = "GET lists/members/show")
    ...
    @Category({"lists"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="get/lists/statuses", value = "GET lists/statuses"), @See(href="get/lists/list", value = "GET lists/list"), @See(href="get/lists/memberships", value = "GET lists/memberships"), @See(href="get/lists/ownerships", value = "GET lists/ownerships"), @See(href="get/lists/subscriptions", value = "GET lists/subscriptions")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @SeeAlso({@See(href="get/lists/memberships", value = "GET lists/memberships"), @See(href="get/lists/list", value = "GET lists/list"), @See(href="get/lists/subscriptions", value = "GET lists/subscriptions"), @See(href="get/lists/statuses", value = "GET lists/statuses")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"lists"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="get/lists/list", value = "GET lists/list"), @See(href="get/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href="get/lists/subscriptions", value = "GET lists/subscriptions"), @See(href="get/lists/memberships", value = "GET lists/memberships"), @See(href="get/lists/ownerships", value = "GET lists/ownerships"), @See(href = "/docs/working-with-timelines", value = "Working with Timelines")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"Lists"})
    @SeeAlso({@See(href="get/lists/memberships", value = "GET lists/memberships"), @See(href="get/lists/list", value = "GET lists/list"), @See(href="get/lists/ownerships", value = "GET lists/ownerships"), @See(href="get/lists/statuses", value = "GET lists/statuses")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))

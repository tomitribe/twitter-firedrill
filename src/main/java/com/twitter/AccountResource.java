...
public class AccountResource {
    ...
    @Category({"account"})
    @ApiVersion({"1.1"})
    @See(href="get/account/settings", value = "GET account/settings")
    ...
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href = "/docs/user-profile-images-and-banners", value = "User Profile Images and Banners"), @See(href="post/account/update_profile_banner", value = "POST account/update_profile_banner"), @See(href="get/users/profile_banner", value = "GET users/profile_banner")})
    ...
    @SeeAlso({@See(href="post/account/remove_profile_banner", value = "POST account/remove_profile_banner"), @See(href="post/account/update_profile_background_image", value = "POST account/update_profile_background_image"), @See(href = "/docs/user-profile-images-and-banners", value = "User Profile Images and Banners")})
    ...
    @Category({"account"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href = "/docs/user-profile-images-and-banners", value = "User Profile Images and Banners"), @See(href="get/users/lookup", value = "GET users/lookup")})

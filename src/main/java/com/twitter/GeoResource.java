...
public class GeoResource {
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/POST/geo/place", value = "POST geo/place"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/similar_places", value = "GET geo/similar_places"), @See(href = "/docs/finding-tweets-about-places", value = "Finding Tweets about Places"), @See(href = "/docs/about-geo-place-attributes", value = "About Geo Place Attributes")})
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/search", value = "GET geo/search"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/similar_places", value = "GET geo/similar_places"), @See(href = "/docs/finding-tweets-about-places", value = "Finding Tweets about Places"), @See(href = "/docs/about-geo-place-attributes", value = "About Geo Place Attributes")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @ApiVersion({"1.1"})
    @Tag({"Places &amp;amp; Geo"})
    @SeeAlso({@See(href = "/docs/finding-tweets-about-places", value = "Finding Tweets about Places"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/search", value = "GET geo/search"), @See(href="/staging/apirest/endpoint/twitter/POST/geo/place", value = "POST geo/place"), @See(href = "/docs/about-geo-place-attributes", value = "About Geo Place Attributes")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/geo/similar_places", value = "GET geo/similar_places"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/search", value = "GET geo/search"), @See(href = "/docs/finding-tweets-about-places", value = "Finding Tweets about Places"), @See(href = "/docs/about-geo-place-attributes", value = "About Geo Place Attributes")})

...
public class StatusesResource {
    ...
    @ApiVersion({"1.1"})
    @Tag({"Retweets"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/statuses/mentions_timeline", value = "GET statuses/mentions_timeline"), @See(href="/staging/apirest/endpoint/twitter/GET/statuses/user_timeline", value = "GET statuses/user_timeline"), })
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/statuses", value = "GET lists/statuses")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"Uploading"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/POST/statuses/update", value = "POST statuses/update")})

...
public class FollowersResource {
    ...
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/friends/ids", value = "GET friends/ids"), @See(href="/staging/apirest/endpoint/twitter/GET/followers/list", value = "GET followers/list"), @See(href="/staging/apirest/endpoint/twitter/GET/friends/list", value = "GET friends/list")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"Bulk Operations", "finding users"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/friends/ids", value = "GET friends/ids"), @See(href="/staging/apirest/endpoint/twitter/GET/followers/ids", value = "GET followers/ids"), @See(href="/staging/apirest/endpoint/twitter/GET/friends/list", value = "GET friends/list")})

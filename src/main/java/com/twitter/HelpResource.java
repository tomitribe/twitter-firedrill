...
public class HelpResource {
    ...
    @Category({"help"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/help/privacy", value = "GET help/privacy"), @See(href="/staging/apirest/endpoint/twitter/GET/help/languages", value = "GET help/languages"), @See(href="/staging/apirest/endpoint/twitter/GET/help/tos", value = "GET help/tos")})
    ...
    @Category({"help"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/help/configuration", value = "GET help/configuration"), @See(href="/staging/apirest/endpoint/twitter/GET/help/privacy", value = "GET help/privacy"), @See(href="/staging/apirest/endpoint/twitter/GET/help/tos", value = "GET help/tos")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"help"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/help/configuration", value = "GET help/configuration"), @See(href="/staging/apirest/endpoint/twitter/GET/help/languages", value = "GET help/languages"), @See(href="/staging/apirest/endpoint/twitter/GET/help/tos", value = "GET help/tos")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"help"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/help/configuration", value = "GET help/configuration"), @See(href="/staging/apirest/endpoint/twitter/GET/help/languages", value = "GET help/languages"), @See(href="/staging/apirest/endpoint/twitter/GET/help/privacy", value = "GET help/privacy")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))

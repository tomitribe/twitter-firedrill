...
public class GeoResource {
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/apirest/twitter/POST/geo/place", value = "POST geo/place"), @See(href="/apirest/twitter/GET/geo/similar_places", value = "GET geo/similar_places"), @See(href = "/docs/finding-tweets-about-places", value = "Finding Tweets about Places"), @See(href = "/docs/about-geo-place-attributes", value = "About Geo Place Attributes")})
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/apirest/twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href="/apirest/twitter/GET/geo/search", value = "GET geo/search"), @See(href="/apirest/twitter/GET/geo/similar_places", value = "GET geo/similar_places"), @See(href = "/docs/finding-tweets-about-places", value = "Finding Tweets about Places"), @See(href = "/docs/about-geo-place-attributes", value = "About Geo Place Attributes")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @ApiVersion({"1.1"})
    @Tag({"Places &amp;amp; Geo"})
    @SeeAlso({@See(href = "/docs/finding-tweets-about-places", value = "Finding Tweets about Places"), @See(href="/apirest/twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href="/apirest/twitter/GET/geo/search", value = "GET geo/search"), @See(href="/apirest/twitter/POST/geo/place", value = "POST geo/place"), @See(href = "/docs/about-geo-place-attributes", value = "About Geo Place Attributes")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/apirest/twitter/GET/geo/similar_places", value = "GET geo/similar_places"), @See(href="/apirest/twitter/GET/geo/search", value = "GET geo/search"), @See(href = "/docs/finding-tweets-about-places", value = "Finding Tweets about Places"), @See(href = "/docs/about-geo-place-attributes", value = "About Geo Place Attributes")})

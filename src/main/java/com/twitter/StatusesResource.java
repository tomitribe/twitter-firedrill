...
public class StatusesResource {
    ...
    public Response getFirehose(@Description("The number of messages to backfill. See <a href=\"https://dev.twitter.com/docs/streaming-apis/parameters#count\">the count parameter documentation</a> for more information.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding tweets"})
    @See(href = "endpoint/Twitter/GET/statuses/user_timeline", value = "GET statuses/user_timeline")
    ...
    public Response getHome_timeline(@Description("Specifies the number of records to retrieve. Must be less than or equal to 200. Defaults to 20.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Mentions"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href = "endpoint/Twitter/GET/statuses/user_timeline", value = "GET statuses/user_timeline")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    public Response getOembed(@Description("The Tweet/status ID to return embed code for.")
                              ...
                              @QueryParam("maxwidth") final Integer maxwidth, @Description("Specifies whether the embedded Tweet should automatically expand images which were uploaded via <a href=\"https://dev.twitter.com/staging/apirest/endpoint/twitter/POST/statuses/update_with_media\">POST statuses/update_with_media</a>. When set to either <tt>true</tt>, <tt>t</tt> or <tt>1</tt> images will not be expanded. Defaults to false.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Retweets"})
    @See(href = "endpoint/Twitter/GET/statuses/retweets/%3Aid", value = "GET statuses/retweets/:id")
    ...
    public Response getRetweetersids(@Description("The numerical ID of the desired status.")
    ...
    public Response getRetweetsid(@Description("The numerical ID of the desired status.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Retweets"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/statuses/mentions_timeline", value = "GET statuses/mentions_timeline"), @See(href = "endpoint/Twitter/GET/statuses/user_timeline", value = "GET statuses/user_timeline"),})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    public Response getRetweets_of_me(@Description("Specifies the number of records to retrieve. Must be less than or equal to 100. If omitted, 20 will be assumed.")
                                      @QueryParam("count") final Integer count, @Description("Returns results with an ID greater than (that is, more recent than) the specified ID. There are limits to the number of Tweets which can be accessed through the API. If the limit of Tweets has occured since the since_id, the since_id will be forced to the oldest ID available.")
                                      @QueryParam("since_id") final Integer since_id, @Description("Returns results with an ID less than (that is, older than) or equal to the specified ID.")
                                      @QueryParam("max_id") final Integer max_id, @Description("When set to either <tt>true</tt>, <tt>t</tt> or <tt>1</tt>, each tweet returned in a timeline will include a user object including only the status authors numerical ID. Omit this parameter to receive the complete user object.")
                                      @QueryParam("trim_user") final Boolean trim_user,
    ...
    public Response getSample(@Description("Specifies whether messages should be length-delimited. See <a href=\"https://dev.twitter.com/docs/streaming-apis/parameters#delimited\">the delimited parameter documentation</a> for more information.")
                              @QueryParam("delimited") final String delimited, @Description("Specifies whether stall warnings should be delivered. See <a href=\"https://dev.twitter.com/docs/streaming-apis/parameters#stall_warnings\">the stall_warnings parameter documentation</a> for more information.")
                              @QueryParam("stall_warnings") final String stall_warnings) {
        //TODO: implement
        return function.get();
    ...
    public Response getShowid(@Description("The numerical ID of the desired Tweet.")
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href = "endpoint/Twitter/GET/lists/statuses", value = "GET lists/statuses")})
    ...
    public Response getUser_timeline(@Description("The ID of the user for whom to return results for.")
    ...
    public Response postDestroyid(@Description("The numerical ID of the desired status.")
                                  @PathParam("id") final int id, @Description("When set to either <tt>true</tt>, <tt>t</tt> or <tt>1</tt>, each tweet returned in a timeline will include a user object including only the status authors numerical ID. Omit this parameter to receive the complete user object.")
                                  @QueryParam("trim_user") final Boolean trim_user) {
        //TODO: implement
        return function.get();
    ...
    public Response postFilter(@Description("A comma separated list of user IDs, indicating the users to return statuses for in the stream. See <a href=\"https://dev.twitter.com/docs/streaming-apis/parameters#follow\">the follow parameter documentation</a> for more information.")
    ...
    public Response postRetweetid(@Description("The numerical ID of the desired status.")
                                  @PathParam("id") final int id, @Description("When set to either <tt>true</tt>, <tt>t</tt> or <tt>1</tt>, each tweet returned in a timeline will include a user object including only the status authors numerical ID. Omit this parameter to receive the complete user object.")
                                  @QueryParam("trim_user") final Boolean trim_user) {
        //TODO: implement
        return function.get();
    ...
    public Response postUpdate(@Description("The text of your status update, typically up to 140 characters. URL encode as necessary. <a href=\"https://dev.twitter.com/docs/tco-link-wrapper/faq\">t.co link wrapping</a> may effect character counts.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Uploading"})
    @SeeAlso({@See(href = "endpoint/Twitter/POST/statuses/update", value = "POST statuses/update")})

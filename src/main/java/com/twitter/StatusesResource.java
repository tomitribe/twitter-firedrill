...
public class StatusesResource {
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding tweets"})
    @See(href="get/statuses/user_timeline", value = "GET statuses/user_timeline")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Mentions"})
    @SeeAlso({@See(href="get/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href="get/statuses/user_timeline", value = "GET statuses/user_timeline")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    public TweetsType getOembed(@Description("The Tweet/status ID to return embed code for.")
                                ...
                                @QueryParam("maxwidth") final Integer maxwidth, @Description("Specifies whether the embedded Tweet should automatically expand images which were uploaded via <a href=\"https://dev.twitter.com/docs/api/1.1/post/statuses/update_with_media\">POST statuses/update_with_media</a>. When set to either <tt>true</tt>, <tt>t</tt> or <tt>1</tt> images will not be expanded. Defaults to false.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Retweets"})
    @See(href="get/statuses/retweets/%3Aid", value = "GET statuses/retweets/:id")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Retweets"})
    @SeeAlso({@See(href="get/statuses/mentions_timeline", value = "GET statuses/mentions_timeline"), @See(href="get/statuses/user_timeline", value = "GET statuses/user_timeline"), @See(href = "/docs/working-with-timelines", value = "Working with Timelines")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="get/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href="get/lists/statuses", value = "GET lists/statuses"), @See(href = "/docs/working-with-timelines", value = "Working with Timelines"), @See(href = "/docs/embedded-timelines", value = "Embedded Timelines"), @See(href = "/docs/embedded-tweets", value = "Embedded Tweets")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"Uploading"})
    @SeeAlso({@See(href = "/docs/uploading-media", value = "Uploading Media"), @See(href="post/statuses/update", value = "POST statuses/update")})

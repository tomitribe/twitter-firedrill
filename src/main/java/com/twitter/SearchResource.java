...
public class SearchResource {
    ...
    @SeeAlso({@See(href = "endpoint/Twitter/GET/users/search", value = "GET users/search"), @See(href = "endpoint/Twitter/GET/geo/search", value = "GET geo/search"),})
    ...
    public Response getTweets(@Description("A UTF-8, URL-encoded search query of 1,000 characters maximum, including operators. Queries may additionally be limited by complexity.")

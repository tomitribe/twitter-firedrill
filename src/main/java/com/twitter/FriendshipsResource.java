...
public class FriendshipsResource {
    ...
    @See(href="get/friendships/outgoing", value = "GET friendships/outgoing")
    ...
    @See(href="get/users/lookup", value = "GET users/lookup")
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @ApiVersion({"1.1"})
    @Tag({"Retweets"})
    @SeeAlso({@See(href="post/friendships/update", value = "POST friendships/update"), @See(href="get/friendships/lookup", value = "GET friendships/lookup"), @See(href="get/user", value = "GET user")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @ApiVersion({"1.1"})
    @Tag({"follower management"})
    @See(href="get/friendships/incoming", value = "GET friendships/incoming")
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @ApiVersion({"1.1"})
    @Tag({"follower management"})
    @See(href="get/friendships/lookup", value = "GET friendships/lookup")
    ...
    @SeeAlso({@See(href="post/friendships/create", value = "POST friendships/create"), @See(href="get/friendships/lookup", value = "GET friendships/lookup")})

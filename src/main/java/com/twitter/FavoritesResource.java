...
public class FavoritesResource {
    ...
    @ApiVersion({"1.1"})
    @Tag({"Favorites"})
    @SeeAlso({@See(href = "/docs/working-with-timelines", value = "Working with Timelines"), @See(href="/apirest/twitter/POST/favorites/create", value = "POST favorites/create"), @See(href="/apirest/twitter/POST/favorites/destroy", value = "POST favorites/destroy")})
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/apirest/twitter/POST/favorites/destroy", value = "POST favorites/destroy"), @See(href="/apirest/twitter/GET/favorites/list", value = "GET favorites/list")})
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/apirest/twitter/GET/favorites/list", value = "GET favorites/list"), @See(href="/apirest/twitter/POST/favorites/create", value = "POST favorites/create")})

...
public class FavoritesResource {
    ...
    @ApiVersion({"1.1"})
    @Tag({"Favorites"})
    @SeeAlso({@See(href = "/docs/working-with-timelines", value = "Working with Timelines"), @See(href="post/favorites/create", value = "POST favorites/create"), @See(href="post/favorites/destroy", value = "POST favorites/destroy")})
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="post/favorites/destroy", value = "POST favorites/destroy"), @See(href="get/favorites/list", value = "GET favorites/list")})
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="get/favorites/list", value = "GET favorites/list"), @See(href="post/favorites/create", value = "POST favorites/create")})

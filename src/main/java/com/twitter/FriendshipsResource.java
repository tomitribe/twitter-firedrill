...
public class FriendshipsResource {
    ...
    @See(href="/apirest/twitter/GET/friendships/outgoing", value = "GET friendships/outgoing")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Retweets"})
    @SeeAlso({@See(href="/apirest/twitter/POST/friendships/update", value = "POST friendships/update"), @See(href="/apirest/twitter/GET/friendships/lookup", value = "GET friendships/lookup"), @See(href="/apirest/twitter/GET/user", value = "GET user")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @ApiVersion({"1.1"})
    @Tag({"follower management"})
    @See(href="/apirest/twitter/GET/friendships/incoming", value = "GET friendships/incoming")
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @ApiVersion({"1.1"})
    @Tag({"follower management"})
    @See(href="/apirest/twitter/GET/friendships/lookup", value = "GET friendships/lookup")
    ...
    @SeeAlso({@See(href="/apirest/twitter/POST/friendships/create", value = "POST friendships/create"), @See(href="/apirest/twitter/GET/friendships/lookup", value = "GET friendships/lookup")})

...
public class StatusesResource {
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding tweets"})
    @See(href="/staging/apirest/endpoint/twitter/GET/statuses/user_timeline", value = "GET statuses/user_timeline")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Mentions"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href="/staging/apirest/endpoint/twitter/GET/statuses/user_timeline", value = "GET statuses/user_timeline")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @ApiVersion({"1.1"})
    @Tag({"Retweets"})
    @See(href="/staging/apirest/endpoint/twitter/GET/statuses/retweets/%3Aid", value = "GET statuses/retweets/:id")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Retweets"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/statuses/mentions_timeline", value = "GET statuses/mentions_timeline"), @See(href="/staging/apirest/endpoint/twitter/GET/statuses/user_timeline", value = "GET statuses/user_timeline"), @See(href = "/docs/working-with-timelines", value = "Working with Timelines")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/statuses", value = "GET lists/statuses"), @See(href = "/docs/working-with-timelines", value = "Working with Timelines"), @See(href = "/docs/embedded-timelines", value = "Embedded Timelines"), @See(href = "/docs/embedded-tweets", value = "Embedded Tweets")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"Uploading"})
    @SeeAlso({@See(href = "/docs/uploading-media", value = "Uploading Media"), @See(href="/staging/apirest/endpoint/twitter/POST/statuses/update", value = "POST statuses/update")})

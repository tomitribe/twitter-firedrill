...
public class TrendsResource {
    ...
    @Category({"trends"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/apirest/twitter/GET/trends/place", value = "GET trends/place"), @See(href="/apirest/twitter/GET/trends/closest", value = "GET trends/closest")})
    ...
    @Category({"trends"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/apirest/twitter/GET/trends/available", value = "GET trends/available"), @See(href="/apirest/twitter/GET/trends/closest", value = "GET trends/closest")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))

...
public class Oauth2Resource {
    ...
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/POST/oauth2/token", value = "POST oauth2/token")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"OAuth"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/POST/oauth2/invalidate_token", value = "POST oauth2/invalidate_token")})

...
public class SavedsearchesResource {
    ...
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/saved_searches/show/%3Aid", value = "GET saved_searches/show/:id"), @See(href="/staging/apirest/endpoint/twitter/POST/saved_searches/create", value = "POST saved_searches/create"), @See(href="/staging/apirest/endpoint/twitter/POST/saved_searches/destroy/%3Aid", value = "POST saved_searches/destroy/:id"), @See(href="/staging/apirest/endpoint/twitter/GET/search/tweets", value = "GET search/tweets")})
    ...
    @Category({"saved_searches"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/saved_searches/list", value = "GET saved_searches/list"), @See(href="/staging/apirest/endpoint/twitter/POST/saved_searches/destroy/%3Aid", value = "POST saved_searches/destroy/:id"), @See(href="/staging/apirest/endpoint/twitter/POST/saved_searches/create", value = "POST saved_searches/create"), @See(href="/staging/apirest/endpoint/twitter/GET/search/tweets", value = "GET search/tweets")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"saved_searches"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/saved_searches/list", value = "GET saved_searches/list"), @See(href="/staging/apirest/endpoint/twitter/GET/saved_searches/show/%3Aid", value = "GET saved_searches/show/:id"), @See(href="/staging/apirest/endpoint/twitter/POST/saved_searches/create", value = "POST saved_searches/create")})

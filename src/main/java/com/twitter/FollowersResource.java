...
public class FollowersResource {
    ...
    @SeeAlso({@See(href="get/friends/ids", value = "GET friends/ids"), @See(href="get/followers/list", value = "GET followers/list"), @See(href="get/friends/list", value = "GET friends/list"), @See(href = "/docs/misc/cursoring", value = "Using cursors to navigate collections")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"Bulk Operations", "finding users"})
    @SeeAlso({@See(href="get/friends/ids", value = "GET friends/ids"), @See(href="get/followers/ids", value = "GET followers/ids"), @See(href="get/friends/list", value = "GET friends/list")})

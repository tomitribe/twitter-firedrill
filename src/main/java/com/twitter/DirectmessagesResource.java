...
public class DirectmessagesResource {
    ...
    @ApiVersion({"1.1"})
    @Tag({"Direct Messages"})
    @SeeAlso({@See(href="/apirest/twitter/GET/direct_messages", value = "GET direct_messages"), @See(href="/apirest/twitter/GET/direct_messages/sent", value = "GET direct_messages/sent")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))

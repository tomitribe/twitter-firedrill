...
public class FriendsResource {
    ...
    @SeeAlso({@See(href = "endpoint/Twitter/GET/followers/ids", value = "GET followers/ids"), @See(href = "endpoint/Twitter/GET/followers/list", value = "GET followers/list"), @See(href = "endpoint/Twitter/GET/friends/list", value = "GET friends/list")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"Bulk Operations", "finding users"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/friends/ids", value = "GET friends/ids"), @See(href = "endpoint/Twitter/GET/followers/ids", value = "GET followers/ids")})

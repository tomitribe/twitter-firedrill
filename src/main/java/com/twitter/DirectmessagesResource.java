...
public class DirectmessagesResource {
    ...
    public Response getSent(@Description("Returns results with an ID greater than (that is, more recent than) the specified ID. There are limits to the number of Tweets which can be accessed through the API. If the limit of Tweets has occured since the since_id, the since_id will be forced to the oldest ID available.")
    ...
    public Response postDestroy(@Description("The ID of the direct message to delete.")
    ...
    public Response postNew(@Description("The ID of the user who should receive the direct message. Helpful for disambiguating when a valid user ID is also a valid screen name.")

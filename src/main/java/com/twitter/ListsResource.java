...
public class ListsResource {
    ...
    @See(href="/apirest/twitter/GET/lists/members/show", value = "GET lists/members/show")
    ...
    @Category({"lists"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/apirest/twitter/GET/lists/statuses", value = "GET lists/statuses"), @See(href="/apirest/twitter/GET/lists/list", value = "GET lists/list"), @See(href="/apirest/twitter/GET/lists/memberships", value = "GET lists/memberships"), @See(href="/apirest/twitter/GET/lists/ownerships", value = "GET lists/ownerships"), @See(href="/apirest/twitter/GET/lists/subscriptions", value = "GET lists/subscriptions")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @SeeAlso({@See(href="/apirest/twitter/GET/lists/memberships", value = "GET lists/memberships"), @See(href="/apirest/twitter/GET/lists/list", value = "GET lists/list"), @See(href="/apirest/twitter/GET/lists/subscriptions", value = "GET lists/subscriptions"), @See(href="/apirest/twitter/GET/lists/statuses", value = "GET lists/statuses")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"lists"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/apirest/twitter/GET/lists/list", value = "GET lists/list"), @See(href="/apirest/twitter/GET/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href="/apirest/twitter/GET/lists/subscriptions", value = "GET lists/subscriptions"), @See(href="/apirest/twitter/GET/lists/memberships", value = "GET lists/memberships"), @See(href="/apirest/twitter/GET/lists/ownerships", value = "GET lists/ownerships"), @See(href = "/docs/working-with-timelines", value = "Working with Timelines")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"Lists"})
    @SeeAlso({@See(href="/apirest/twitter/GET/lists/memberships", value = "GET lists/memberships"), @See(href="/apirest/twitter/GET/lists/list", value = "GET lists/list"), @See(href="/apirest/twitter/GET/lists/ownerships", value = "GET lists/ownerships"), @See(href="/apirest/twitter/GET/lists/statuses", value = "GET lists/statuses")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))

...
public class GeoResource {
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/POST/geo/place", value = "POST geo/place"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/similar_places", value = "GET geo/similar_places")})
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/search", value = "GET geo/search"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/similar_places", value = "GET geo/similar_places")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/reverse_geocode", value = "GET geo/reverse_geocode")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @ApiVersion({"1.1"})
    @Tag({"Places &amp;amp; Geo"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/search", value = "GET geo/search"), @See(href="/staging/apirest/endpoint/twitter/POST/geo/place", value = "POST geo/place"), })
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/geo/similar_places", value = "GET geo/similar_places"), @See(href="/staging/apirest/endpoint/twitter/GET/geo/search", value = "GET geo/search")})

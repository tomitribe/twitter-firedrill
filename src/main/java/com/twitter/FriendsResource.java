...
public class FriendsResource {
    ...
    @SeeAlso({@See(href="/apirest/twitter/GET/followers/ids", value = "GET followers/ids"), @See(href="/apirest/twitter/GET/followers/list", value = "GET followers/list"), @See(href="/apirest/twitter/GET/friends/list", value = "GET friends/list"), @See(href = "/docs/misc/cursoring", value = "Using cursors to navigate collections")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"Bulk Operations", "finding users"})
    @SeeAlso({@See(href="/apirest/twitter/GET/friends/ids", value = "GET friends/ids"), @See(href="/apirest/twitter/GET/followers/ids", value = "GET followers/ids")})

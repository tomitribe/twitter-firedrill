...
public class HelpResource {
    ...
    @Category({"help"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="get/help/privacy", value = "GET help/privacy"), @See(href="get/help/languages", value = "GET help/languages"), @See(href="get/help/tos", value = "GET help/tos")})
    ...
    @Category({"help"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="get/help/configuration", value = "GET help/configuration"), @See(href="get/help/privacy", value = "GET help/privacy"), @See(href="get/help/tos", value = "GET help/tos")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"help"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="get/help/configuration", value = "GET help/configuration"), @See(href="get/help/languages", value = "GET help/languages"), @See(href="get/help/tos", value = "GET help/tos")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"help"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="get/help/configuration", value = "GET help/configuration"), @See(href="get/help/languages", value = "GET help/languages"), @See(href="get/help/privacy", value = "GET help/privacy")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))

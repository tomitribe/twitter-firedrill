...
public class GeoResource {
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href = "endpoint/Twitter/POST/geo/place", value = "POST geo/place"), @See(href = "endpoint/Twitter/GET/geo/similar_places", value = "GET geo/similar_places")})
    ...
    public Response getIdplace_id(@Description("A place in the world. These IDs can be retrieved from geo/reverse_geocode.")
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href = "endpoint/Twitter/GET/geo/search", value = "GET geo/search"), @See(href = "endpoint/Twitter/GET/geo/similar_places", value = "GET geo/similar_places")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    public Response getReverse_geocode(@Description("The latitude to search around. This parameter will be ignored unless it is inside the range -90.0 to +90.0 (North is positive) inclusive. It will also be ignored if there isn't a corresponding <tt>long</tt> parameter.")
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href = "endpoint/Twitter/GET/geo/reverse_geocode", value = "GET geo/reverse_geocode")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    public Response getSearch(@Description("The latitude to search around. This parameter will be ignored unless it is inside the range -90.0 to +90.0 (North is positive) inclusive. It will also be ignored if there isn't a corresponding <tt>long</tt> parameter.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"Places &amp;amp; Geo"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/geo/id/%3Aplace_id", value = "GET geo/id/:place_id"), @See(href = "endpoint/Twitter/GET/geo/search", value = "GET geo/search"), @See(href = "endpoint/Twitter/POST/geo/place", value = "POST geo/place"),})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @Description("Locates places near the given coordinates which are similar in name.")
    public Response getSimilar_places(@Description("The latitude to search around. This parameter will be ignored unless it is inside the range -90.0 to +90.0 (North is positive) inclusive. It will also be ignored if there isn't a corresponding <tt>long</tt> parameter.")
                                      @PathParam("lat") final String lat, @Description("The longitude to search around. The valid ranges for longitude is -180.0 to +180.0 (East is positive) inclusive. This parameter will be ignored if outside that range, if it is not a number, if <tt>geo_enabled</tt> is disabled, or if there not a corresponding <tt>lat</tt> parameter.")
    ...
    @Category({"geo"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/geo/similar_places", value = "GET geo/similar_places"), @See(href = "endpoint/Twitter/GET/geo/search", value = "GET geo/search")})
    ...
    public Response postPlace(@Description("The name a place is known as.")

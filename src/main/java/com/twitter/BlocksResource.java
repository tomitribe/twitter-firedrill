...
public class BlocksResource {
    ...
    @Category({"blocks"})
    @ApiVersion({"1.1"})
    @See(href="get/blocks/list", value = "GET blocks/list")
    ...
    @Category({"blocks"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="get/blocks/ids", value = "GET blocks/ids"), @See(href = "/docs/misc/cursoring", value = "Using cursors to navigate collections")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))

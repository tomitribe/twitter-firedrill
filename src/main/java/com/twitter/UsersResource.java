...
public class UsersResource {
    ...
    @ApiVersion({"1.1"})
    @Tag({"contributors"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/users/lookup", value = "GET users/lookup"), @See(href="/staging/apirest/endpoint/twitter/GET/users/contributors", value = "GET users/contributors")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"contributors"})
    @See(href="/staging/apirest/endpoint/twitter/GET/users/contributees", value = "GET users/contributees")
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/users/search", value = "GET users/search"), @See(href="/staging/apirest/endpoint/twitter/GET/users/show", value = "GET users/show")})
    ...
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/POST/account/remove_profile_banner", value = "POST account/remove_profile_banner"), @See(href="/staging/apirest/endpoint/twitter/POST/account/update_profile_banner", value = "POST account/update_profile_banner"), @See(href = "/docs/user-profile-images-and-banners", value = "User Profile Images and Banners")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 180))
    ...
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/users/lookup", value = "GET users/lookup"), @See(href="/staging/apirest/endpoint/twitter/GET/users/show", value = "GET users/show"), @See(href="/staging/apirest/endpoint/twitter/GET/search/tweets", value = "GET search/tweets")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 180))
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding users"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/friends/ids", value = "GET friends/ids"), @See(href="/staging/apirest/endpoint/twitter/GET/followers/ids", value = "GET followers/ids"), @See(href="/staging/apirest/endpoint/twitter/GET/users/lookup", value = "GET users/lookup"), @See(href="/staging/apirest/endpoint/twitter/GET/users/search", value = "GET users/search"), @See(href = "/docs/user-profile-images-and-banners", value = "User Profile Images and Banners")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding users"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/users/suggestions/%3Aslug", value = "GET users/suggestions/:slug"), @See(href="/staging/apirest/endpoint/twitter/GET/users/suggestions/%3Aslug/members", value = "GET users/suggestions/:slug/members")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding users"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/users/suggestions", value = "GET users/suggestions"), @See(href="/staging/apirest/endpoint/twitter/GET/users/suggestions/%3Aslug", value = "GET users/suggestions/:slug")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding users"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/users/suggestions/%3Aslug", value = "GET users/suggestions/:slug"), @See(href="/staging/apirest/endpoint/twitter/GET/users/suggestions", value = "GET users/suggestions")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))

...
public class UsersResource {
    ...
    @ApiVersion({"1.1"})
    @Tag({"contributors"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/users/lookup", value = "GET users/lookup"), @See(href = "endpoint/Twitter/GET/users/contributors", value = "GET users/contributors")})
    ...
    public Response getContributees(@Description("The ID of the user for whom to return results for. Helpful for disambiguating when a valid user ID is also a valid screen name.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"contributors"})
    @See(href = "endpoint/Twitter/GET/users/contributees", value = "GET users/contributees")
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @Description("Returns a collection of users who can contribute to the specified account.")
    public Response getContributors(@Description("The ID of the user for whom to return results for.")
                                    @QueryParam("user_id") final String user_id, @Description("The screen name of the user for whom to return results for.")
                                    @QueryParam("screen_name") final String screen_name, @Description("The <tt>entities</tt> node will be disincluded when set to <tt>false</tt>.")
                                    @QueryParam("include_entities") final Boolean include_entities, @Description("When set to either <tt>true</tt>, <tt>t</tt> or <tt>1</tt> statuses will not be included in the returned user objects.")
                                    @QueryParam("skip_status") final String skip_status) {
    ...
    @SeeAlso({@See(href = "endpoint/Twitter/GET/users/search", value = "GET users/search"), @See(href = "endpoint/Twitter/GET/users/show", value = "GET users/show")})
    ...
    public Response getLookup(@Description("A comma separated list of screen names, up to 100 are allowed in a single request. You are strongly encouraged to use a POST for larger (up to 100 screen names) requests.")
    ...
    @SeeAlso({@See(href = "endpoint/Twitter/POST/account/remove_profile_banner", value = "POST account/remove_profile_banner"), @See(href = "endpoint/Twitter/POST/account/update_profile_banner", value = "POST account/update_profile_banner"),})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 180))
    ...
    @SeeAlso({@See(href = "endpoint/Twitter/GET/users/lookup", value = "GET users/lookup"), @See(href = "endpoint/Twitter/GET/users/show", value = "GET users/show"), @See(href = "endpoint/Twitter/GET/search/tweets", value = "GET search/tweets")})
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 180))
    ...
    public Response getSearch(@Description("The search query to run against people search.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding users"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/friends/ids", value = "GET friends/ids"), @See(href = "endpoint/Twitter/GET/followers/ids", value = "GET followers/ids"), @See(href = "endpoint/Twitter/GET/users/lookup", value = "GET users/lookup"), @See(href = "endpoint/Twitter/GET/users/search", value = "GET users/search"),})
    ...
    public Response getShow(@Description("The ID of the user for whom to return results for. Either an id or screen_name is required for this method.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding users"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/users/suggestions/%3Aslug", value = "GET users/suggestions/:slug"), @See(href = "endpoint/Twitter/GET/users/suggestions/%3Aslug/members", value = "GET users/suggestions/:slug/members")})
    ...
    public Response getSuggestions(@Description("Restricts the suggested categories to the requested language. The language must be specified by the appropriate two letter ISO 639-1 representation. Currently supported languages are provided by the <a href=\"https://dev.twitter.com/staging/apirest/endpoint/twitter/GET/help/languages\">GET help/languages</a> API request. Unsupported language codes will receive English (en) results. If you use <tt>lang</tt> in this request, ensure you also include it when requesting the <a href=\"https://dev.twitter.com/staging/apirest/endpoint/twitter/GET/users/suggestions/%3Aslug\">GET users/suggestions/:slug</a> list.")
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding users"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/users/suggestions", value = "GET users/suggestions"), @See(href = "endpoint/Twitter/GET/users/suggestions/%3Aslug", value = "GET users/suggestions/:slug")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"finding users"})
    @SeeAlso({@See(href = "endpoint/Twitter/GET/users/suggestions/%3Aslug", value = "GET users/suggestions/:slug"), @See(href = "endpoint/Twitter/GET/users/suggestions", value = "GET users/suggestions")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    public Response getSuggestionsslugmembers(@Description("The short name of list or a category")
    ...
    public Response postReport_spam(@Description("The ID or screen_name of the user you want to report as a spammer. Helpful for disambiguating when a valid screen name is also a user ID.")

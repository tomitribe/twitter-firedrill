...
public class ListsResource {
    ...
    @See(href="/staging/apirest/endpoint/twitter/GET/lists/members/show", value = "GET lists/members/show")
    ...
    @Category({"lists"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/lists/statuses", value = "GET lists/statuses"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/list", value = "GET lists/list"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/memberships", value = "GET lists/memberships"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/ownerships", value = "GET lists/ownerships"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/subscriptions", value = "GET lists/subscriptions")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/lists/memberships", value = "GET lists/memberships"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/list", value = "GET lists/list"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/subscriptions", value = "GET lists/subscriptions"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/statuses", value = "GET lists/statuses")})
    @ApplicationLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    @UserLimit(rate = @Rate(window = 15, unit = GovernanceUnit.MINUTES, limit = 15))
    ...
    @Category({"lists"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/lists/list", value = "GET lists/list"), @See(href="/staging/apirest/endpoint/twitter/GET/statuses/home_timeline", value = "GET statuses/home_timeline"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/subscriptions", value = "GET lists/subscriptions"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/memberships", value = "GET lists/memberships"), @See(href="/staging/apirest/endpoint/twitter/GET/lists/ownerships", value = "GET lists/ownerships"), @See(href = "/docs/working-with-timelines", value = "Working with Timelines")})

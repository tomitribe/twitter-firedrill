...
public class FriendshipsResource {
    ...
    public Response getLookup(@Description("A comma separated list of screen names, up to 100 are allowed in a single request.")
        ...
        //TODO: implement
        return function.getFunction().apply(Response.ok()).build();
    }
    ...
    public Response getNo_retweetsids(@Description("Many programming environments will not consume our ids due to their size. Provide this option to have ids returned as strings instead. Read more about <a href=\"https://dev.twitter.com/docs/twitter-ids-json-and-snowflake\">Twitter IDs, JSON and Snowflake</a>. This parameter is especially important to use in Javascript environments.")
                                      @QueryParam("stringify_ids") final Boolean stringify_ids) {
        //TODO: implement
        return function.get();
    }
    ...
    public Response postCreate(@Description("The screen name of the user for whom to befriend. ")
    ...
    public Response postDestroy(@Description("The screen name of the user for whom to unfollow. ")

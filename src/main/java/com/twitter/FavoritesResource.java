...
public class FavoritesResource {
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/POST/favorites/destroy", value = "POST favorites/destroy"), @See(href="/staging/apirest/endpoint/twitter/GET/favorites/list", value = "GET favorites/list")})
    ...
    @Category({"statuses"})
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href="/staging/apirest/endpoint/twitter/GET/favorites/list", value = "GET favorites/list"), @See(href="/staging/apirest/endpoint/twitter/POST/favorites/create", value = "POST favorites/create")})

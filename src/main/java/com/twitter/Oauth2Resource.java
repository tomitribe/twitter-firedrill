...
public class Oauth2Resource {
    ...
    @ApiVersion({"1.1"})
    @SeeAlso({@See(href = "/docs/auth/application-only-auth", value = "Application-only authentication"), @See(href="/staging/apirest/endpoint/twitter/POST/oauth2/token", value = "POST oauth2/token")})
    ...
    @ApiVersion({"1.1"})
    @Tag({"OAuth"})
    @SeeAlso({@See(href = "/docs/auth/application-only-auth", value = "Application-only authentication"), @See(href = "/docs/rate-limiting/1.1", value = "REST API Rate Limiting in v1.1"), @See(href="/staging/apirest/endpoint/twitter/POST/oauth2/invalidate_token", value = "POST oauth2/invalidate_token")})
